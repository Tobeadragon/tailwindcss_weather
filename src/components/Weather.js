...
const Weather = ({city_name, color_name}) => {
  ...
  if(loading){
    return <div><svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="w-full px-8 absolute top-6">
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-lg font-medium tracking-widest">{city_name}</p>
            </div>
            <div>
